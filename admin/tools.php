...
<div class="block">
<div class="block-title"><h3 class="panel-title">工具大全</h3></div>
<div class="card-body">
<p class="text-muted font-14">此界面的多个功能按钮可以更好的协助您使用本程序！<br>
<span class="text-danger">数据无价，请谨慎操作！</span></p>
...
<a href="./tools.php?url=pzdr"class="all_button join_in_button wow fadeInUp">导入骗子</a>
<a href="./tools.php?url=dhdr"class="all_button join_in_button wow fadeInUp">导入导航</a>
<a href="./clean.php"class="all_button join_in_button wow fadeInUp">数据清除</a>
</div>
<?php
}if($url=="jsq"){
?>
<div class="block">
<div class="block-title"><h3 class="panel-title">计算器工具</h3></h3></div>
<div class="card-body">
...
?>
<div class="block">
<div class="block-title"><h3 class="panel-title">音乐解析</h3></div>
<div class="card-body">
...
?>
<div class="block">
<div class="block-title"><h3 class="panel-title">云端骗子导入</h3></div>
<div class="card-body">
		<p><iframe src="//api.ukyun.cn/website/liar/liars.html" style="width:100%;height:350px;"></iframe></p>
		<p align="center"><a class="btn btn-primary" href="../api/liar_api.php?do=1" onclick="return confirm('将会覆盖本地数据库的骗子表,确定操作嘛?(此操作不可恢复,备份第一!)')">开始(请确保根目录/api/liar_api.lock文件已删除)</a></p>
	</div>
</div>
<?php
}if($url=="dhdr"){
?>
<div class="block">
<div class="block-title"><h3 class="panel-title">云端导航导入</h3></div>
<div class="card-body">
		<p><iframe src="//api.ukyun.cn/website/list/list.html" style="width:100%;height:350px;"></iframe></p>
		<p align="center"><a class="btn btn-primary" href="../api/list_api.php?do=1" onclick="return confirm('将会覆盖本地数据库的导航表确定操作嘛?(此操作不可恢复,备份第一!)')">开始(请确保根目录/api/list_api.lock文件已删除)</a></p>
	</div>
</div>
