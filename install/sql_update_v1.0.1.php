...
if(file_exists('sql_v1.0.1.lock')){
	$updated=true;
	$do='0';
}
?>
...
<nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        <span class="navbar-brand">数据库 V1.0.1 更新模块</span>
      </div><!-- /.navbar-header -->
    </div><!-- /.container -->
  </nav><!-- /.navbar -->
...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		...
		<br>
		<?php if($updated){ ?>
		<div class="alert alert-warning">当前版本数据库您已经更新过,如需重新更新请删除<font color=red>sql_v1.0.1.lock 文件</font></div>
		<?php }else{?>
...
if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
	...
	$sql=file_get_contents("sql_v1.0.1.sql");
	$sql=explode(';',$sql);
...
<div class="progress progress-striped">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
	...
	<div class="panel-body">
<?php
	@file_put_contents("sql_v1.0.1.lock",'数据库V1.0.1更新锁');
	echo '<div class="alert alert-info"><font color="green"><center>安装完成！</font><br/><br/><a href="../">>>网站首页</a>｜<a href="../admin/">>>后台管理</a><hr/>UK云工作室版权所有</center></font></div>';
?>
	</div>
</div>
