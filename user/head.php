...
<li class="<?php echo checkIfActive('index.php,index,app')?>">
	<a href="javascript:void(0)" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-home sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">页面导航</span></a>
	<ul>
<li>
	<a class="<?php echo checkIfActive("index.php") ?>" href="../">
		网站首页
	</a>
</li>
<li>
...
<li>
	<a class="<?php echo checkIfActive("app") ?>" href="../app.php">
		APP下载
	</a>
</li>
	</ul>
...
<li class="<?php echo checkIfActive('log,tools,page,liar,admin')?>">
...
<li>
	<a class="<?php echo checkIfActive("page") ?>" href="./page.php">
		站点大全
	</a>
</li>
<li>
...
<li>
	<a class="<?php echo checkIfActive("admin") ?>" href="./admin.php">
		站长列表
	</a>
</li>
	</ul>
...
<li>
	<a class="<?php echo checkIfActive('password')?>" href="./password.php">
		<i class="fa fa-thumbs-o-up sidebar-nav-icon"></i>
